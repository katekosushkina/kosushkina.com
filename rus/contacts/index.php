...
<html>
  <head>
    ...
    <script src="../../js//script_home.js"></script>
      ...
      <script src="../../js//script_rus.js"></script>
  </head>
  <body>
    <div class="box">
      <header role="banner">
      ...
      <nav>
                  <ul class="nav n">
                         ...
                         <li><a id="contacts_rus" class="menu thisnav" alt="контакты" href="../../rus/contacts/">Контакты</a></li>
                  </ul>
      </nav>
      <a id="move_up" href="#">
        <div class="triangle">
		...
		<div class="container">
			<div id="content" class="content">
				<div class="about">
<br>
					<p>Связаться со мной можно здесь:</p>
					...
					<p>За всеми новостями следите в моей группе ВК и инстаграме:</p>
