...
<link rel="stylesheet" href="css/style_web.css" type="text/css"/>
  ...
  <body>
    <div class="box">
      <header role="banner">
              ...
              <div id="language" role="group" aria-label="...">
                          <button type="button" class="btn" onclick="location.href='eng.php'">ENG</button>
                          <button type="button" class="btn" onclick="location.href='rus.php'">RU</button>
              </div>
       </header>
      <nav>
                  <ul class="nav n">
                         <li><a id="home_rus" class="menu thisnav" alt="главная" href="rus.php" >Главная</a></li>
                         <li><a id="photo_rus" class="menu" alt="photo" href="rus/fashion/">Модельные тесты</a></li>
                         <li><a id="photo_rus" class="menu" alt="photo" href="rus/beauty/">Бьюти</a></li>
    ...
    <img src="../img/fashion/original/60.jpg" alt="" />
    <img src="../img/fashion/original/47.jpg" alt="" />
    <img src="../img/fashion/original/10.jpg" alt="" />
    <img src="../img/fashion/original/17.jpg" alt="" />
    <img src="../img/fashion/original/12.jpg" alt="" />
	</div>
