...
<link rel="stylesheet" href="../../css/style_web.css" type="text/css"/>
  ...
  <body>
    <div class="box">
      <header role="banner">
              <a  id="home_eng" class="menu" alt="home" title="Home">Kate Kosushkina <span>photography</span></a>
              <div id="language" role="group" aria-label="...">
                          <button type="button" class="btn" onclick="location.href='../../eng/photo/tourism.php'">ENG</button>
                          <button type="button" class="btn" onclick="location.href='../../rus/photo/tourism.php'">RU</button>
              </div>
       </header>
      <nav>
                  <ul class="nav n">
                         <li><a id="home_eng" class="menu" alt="home" href="../../eng.php" >Home</a></li>
                         <li><a id="photo_eng" class="menu" alt="photo" href="../../eng/photo/">Portfolio</a></li>
                         <li><a id="contacts_eng" class="menu" alt="Contacts" href="../../eng/contacts/">Contacts</a></li>
                  </ul>
      </nav>
      <a id="move_up" href="#">
        <div class="triangle">
        ...
        $ph = scandir('../../img/tourism/original',1);
        foreach ($ph as $value)
        {
        ...
        echo "<div data-src=\"../../img/tourism/original/";
        echo $n;
        echo "\" data-min-width=\"250\"></div>";
        echo "<div data-src=\"../../img/tourism/thumbs/";
        echo $n;
        echo "\"></div><noscript>";
        echo "<img src=\"../../img/tourism/thumbs/";
        echo $n;
        echo "\" /></noscript></div>";
        echo "</li>";
        }
