    ...
    <div class="box">
      <header role="banner">
              ...
              <div id="language" role="group" aria-label="...">
                          <button type="button" class="btn" onclick="location.href='../../eng/photo/fashion.php'">ENG</button>
                          <button type="button" class="btn" onclick="location.href='../../rus/photo/fashion.php'">RU</button>
              </div>
       </header>
      <nav>
                  <ul class="nav n">
      ...
      <a id="move_up" href="#">
        ...
        $ph = scandir('../../img/fashion/original',1);
        foreach ($ph as $value)
        {
        ...
        echo "<div data-src=\"../../img/fashion/original/";
        echo $n;
        echo "\" data-min-width=\"250\"></div>";
        echo "<div data-src=\"../../img/fashion/thumbs/";
        echo $n;
        echo "\"></div><noscript>";
        echo "<img src=\"../../img/fashion/thumbs/";
        echo $n;
        echo "\" /></noscript></div>";
        echo "</li>";
        }
