    ...
    <div class="box">
      <header role="banner">
              ...
              <div id="language" role="group" aria-label="...">
                          <button type="button" class="btn" onclick="location.href='../../eng/photo/'">ENG</button>
                          <button type="button" class="btn" onclick="location.href='../../rus/photo/'">RU</button>
              </div>
       </header>
      <nav>
                  <ul class="nav n">
                         <li><a id="home_eng" class="menu" alt="главная" href="../../eng.php">Home</a></li>
                         <li><a id="photo_eng" class="menu  thisnav" alt="photo" href="../../eng/photo/">Portfolio</a></li>
                         <li><a id="contacts_eng" class="menu" alt="контакты" href="../../eng/contacts/">Contacts</a></li>
                  </ul>
      </nav>
      <a id="move_up" href="#">
        <div class="triangle">
		...
		<div class="container">
			<div id="content" class="content">
				<nav>
					 <ul class="nav">
             <li><a id="fashion" class="bar" alt="fashion" href="fashion.php">	<img src="../../img/fashion/thumbs/61.jpg" alt="img"><br>Fashion</a></li>
             <li><a id="family" class="bar" alt="family" href="family.php"> 	<img src="../../img/family/thumbs/06.jpg" alt="img"><br>Family</a></li>
					  </ul>
